...
> = {
  ...
  speed: {
    n01: { name: 'スピード強化1', description: 'ヒット時のゲージ上昇がわずかに速くなる。', kind: 'stat', statBonus: { gaugeSpeedSkillAdd: 0.01 } },
    n02: { name: 'スピード強化2', description: 'ヒット時のゲージ上昇がわずかに速くなる。', kind: 'stat', statBonus: { gaugeSpeedSkillAdd: 0.01 } },
    n03: {
      name: '一点集中',
    ...
    n04: { name: 'スピード強化3', description: 'ゲージ上昇が速くなる。', kind: 'stat', statBonus: { gaugeSpeedSkillAdd: 0.02 } },
    ...
    n08: { name: 'スピードマスター', description: 'ゲージ上昇がさらに速くなる。', kind: 'stat', statBonus: { gaugeSpeedSkillAdd: 0.05 } },
  },
  technique: {
    ...
    n04: { name: 'テクニック強化3', description: '判定帯が広がる。', kind: 'stat', statBonus: { barRangeSkillAdd: 0.01 } },
    n05: { name: 'テクニック強化4', description: '判定帯が広がる。', kind: 'stat', statBonus: { barRangeSkillAdd: 0.01 } },
    n06: {
      name: '不屈の構え',
  ...
  control: {
    n01: { name: 'コントロール強化1', description: 'バーが目標速度へ追従しやすくなる。', kind: 'stat', statBonus: { fightBarDragSkillAdd: 0.02 } },
    n02: { name: 'コントロール強化2', description: 'バーが目標速度へ追従しやすくなる。', kind: 'stat', statBonus: { fightBarDragSkillAdd: 0.02 } },
    n03: {
      name: 'ロックオン',
    ...
    n04: { name: 'コントロール強化3', description: '追従がさらに速くなる。', kind: 'stat', statBonus: { fightBarDragSkillAdd: 0.03 } },
    n05: { name: 'コントロール強化4', description: '追従がさらに速くなる。', kind: 'stat', statBonus: { fightBarDragSkillAdd: 0.03 } },
    n06: {
      name: 'シルクタッチ',
    ...
    n07: { name: 'コントロール強化5', description: '追従が大きく速くなる。', kind: 'stat', statBonus: { fightBarDragSkillAdd: 0.04 } },
    n08: { name: 'コントロールマスター', description: '追従がさらに速くなる。', kind: 'stat', statBonus: { fightBarDragSkillAdd: 0.06 } },
  },
  special: {
